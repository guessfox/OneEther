...
contract OneEther {
    ...
    mapping(uint256 => OneEtherDatasets.stake[]) public betList_;                   // search by rID,use random to generate key number, locate winner
    mapping(uint256 => OneEtherDatasets.BetState) public rIDBet_; //return state of one round by id
